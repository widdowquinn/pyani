...
def upgrade():
    ...
    with op.batch_alter_table("comparisons", copy_from=old_comparisons) as batch_op:
...
def downgrade():
    ...
    with op.batch_alter_table("comparisons", copy_from=new_comparisons) as batch_op:
